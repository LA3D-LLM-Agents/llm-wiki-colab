...
Full procedure: see `the wiki-source skill` and `.llm-wiki/SCHEMA_<repo>.md`. Summary:
...
7. Update `index_<repo>.md` under "Source summaries".
...
10. **Run the Verification Gate** at `${CURSOR_PLUGIN_ROOT}/core/agents/verification-gate.md` over every page created or edited. Do not commit until all criteria pass. It catches projection-as-fact, missing corpus tags, missing back-references, and missing log/index entries.
